...
public record SignUpRequestDto(String email, String password, String provider) implements ApplicationRequestDto {
    public SignUpRequestDto {
        ...
        requiredArgumentValidation(password, ErrorMessage.NOT_EXIST_PROVIDER.getMessage());
    }
}
